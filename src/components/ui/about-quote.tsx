        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              В NeoChat мы верим, что общение с искусственным интеллектом должно быть простым, быстрым и приятным. Наш чат-клиент объединяет диалоги, работу с файлами и знания в одном удобном окне.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Специалист, решающий рабочие задачи, студент за учёбой или команда, которой нужен общий AI-помощник — NeoChat станет вашим умным собеседником каждый день.
            </p>
          </div>
        </div>
      </div>
